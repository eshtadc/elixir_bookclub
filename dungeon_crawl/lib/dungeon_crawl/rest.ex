defmodule DungeonCrawl.Rest do
  ...
  def heal(character), do: rest_and_heal(character, 3)
  ...
  defp rest_and_heal(%{hit_points: current_hit_points, max_hit_points: max_hit_points} = character, _)
  ...
  defp rest_and_heal(character, remaining) do
    ...
    healed_character = Character.heal(character, 1) # maybe make this random?
